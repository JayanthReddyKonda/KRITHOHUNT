...
export default function CampusGeoguessrGame({ teamId, colorTheme, gameData, onSolved, onIncorrect }) {
    ...
    map.on('click', (e) => {
      ...
      if (markerRef.current) {
        ...
        const customIcon = L.divIcon({
          ...
          html: `
            <div class="w-7 h-7 bg-accent-indigo rounded-full border-2 border-surface-0 shadow-[0_0_12px_rgba(99,102,241,0.6)] flex items-center justify-center animate-pulse">
  ...
  const accentColor = `rgba(${colorTheme?.rgb || '99, 102, 241'}, 0.95)`;
